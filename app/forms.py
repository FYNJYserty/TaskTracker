...
class RegistrationForm(FlaskForm):
    username = StringField('Логин пользователя', [validators.InputRequired(), validators.Length(min=4, max=25)]) # Username field
    ...
    age = IntegerField('Возраст', [validators.InputRequired()]) # Age field
